...
async fn render(mut ctx: RenderContext) -> Result<Response, Error> {
    ctx.metadata(Metadata::new().description("Hashira x Warp example"));
    ...
    yew::html! {
        <div class="container">
            <div class="logo-container">
                ...
                <a href="https://docs.rs/warp/latest/warp/" target="_blank" rel="noopener">
                    <img title="Warp" alt="Warp" src="https://foundation.rust-lang.org/img/rust-logo-blk.svg"/>
                </a>
            </div>
